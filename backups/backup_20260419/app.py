        ...
        <table style="width:100%; border-collapse: collapse; font-size: 0.9rem; border-radius: 8px; overflow: hidden; background-color: white; color: #333;">
            <thead>
                <tr style="background-color: #f8f9fa; color: #333; text-align: left; border-bottom: 2px solid #dee2e6;">
                    ...
                    <th style="padding: 12px 15px;">단가</th>
                    <th style="padding: 12px 15px;">입수량</th>
                    <th style="padding: 12px 15px;">배송비</th>
                    <th style="padding: 12px 15px;">박스당 가격</th>
                    <th style="padding: 12px 15px;">부가세</th>
                    <th style="padding: 12px 15px;">배송비+VAT포함 단가</th>
                    <th style="padding: 12px 15px; color: #2E7D32;">20*30로 환산단가</th>
                </tr>
            </thead>
            <tbody>
    """
    ...
    for _, row in display_df.iterrows():
        ...
        html_table += f"""
                <tr class="{row_class}" style="border-bottom: 1px solid #eee; background-color: {bg_color}; transition: background-color 0.2s;">
                    ...
                    <td style="padding: 10px 15px;">{unit:,}원</td>
                    <td style="padding: 10px 15px;">{qty:,}매</td>
                    <td style="padding: 10px 15px;">{shipping_display}</td>
                    <td style="padding: 10px 15px;">{box_price:,}원</td>
                    <td style="padding: 10px 15px;">{row['부가세']}</td>
                    <td style="padding: 10px 15px; background-color: #FFF0F0; color: #B71C1C;">{cost:,}원</td>
                    <td style="padding: 10px 15px; background-color: #FFF0F0; font-weight: 700; color: #B71C1C;">{conv:,}원</td>
                </tr>
        """
